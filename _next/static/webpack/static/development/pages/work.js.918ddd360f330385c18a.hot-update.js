...
var DynamicWorkingComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_16___default()(function () {
  return __webpack_require__("./components/Work lazy recursive ^\\.\\/.*$")("./".concat(data.id));
}, {
  loadableGenerated: {
    webpack: function webpack() {
      return [/*require.resolve*/(__webpack_require__("./components/Work weak recursive ^\\.\\/.*$").resolve("./".concat(data.id)))];
    },
    modules: ["../../components/Work/".concat(_data_json__WEBPACK_IMPORTED_MODULE_12__["data"].id)]
  }
});
...
//# sourceMappingURL=work.js.918ddd360f330385c18a.hot-update.js.map