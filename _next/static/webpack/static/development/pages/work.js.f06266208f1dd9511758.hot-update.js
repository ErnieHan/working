...
})(["float:left;width:33.3%;.more-subtitle{font-size:13px;color:rgba(0,0,0,0.5);}"]);
...
})(["width:33.33%;height:200px;background:", ";background-size:cover;"], function (props) {
  return "url(/static/img/work/".concat(props.img, ".png) no-repeat center");
});
...
//# sourceMappingURL=work.js.f06266208f1dd9511758.hot-update.js.map