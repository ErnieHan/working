...
var element = "youtube-video-api";
console.log("AAA");
var DynamicWorkingComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_16___default()(function () {
  return __webpack_require__("./components/Work lazy recursive ^\\.\\/.*$")("./".concat(element));
}, {
  loadableGenerated: {
    webpack: function webpack() {
      return [/*require.resolve*/(__webpack_require__("./components/Work weak recursive ^\\.\\/.*$").resolve("./".concat(element)))];
    },
    modules: ["../../components/Work/".concat(element)]
  }
});
...
//# sourceMappingURL=work.js.f7fc5eee66902812c267.hot-update.js.map