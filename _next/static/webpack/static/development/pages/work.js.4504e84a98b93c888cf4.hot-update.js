...
/* harmony import */ var _components_Sidebar__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../components/Sidebar */ "./components/Sidebar/index.js");
 ...
 // const DynamicWorkingComponent = dynamic(() =>
//   import(`../../components/Work/youtube-video-api`)
// );
...
function (_Component2) {
  ...
  function Work(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_6__["default"])(_this), "con", void 0);
    ...
    if (typeof window === "undefined" && isServer) {
      ...
      _Component = Components.map(function (component) {
        return next_dynamic__WEBPACK_IMPORTED_MODULE_10___default()(function () {
    ...
    var DynamicWorkingComponent = next_dynamic__WEBPACK_IMPORTED_MODULE_10___default()(function () {
      return __webpack_require__("./components/Work lazy recursive ^\\.\\/.*$")("./".concat(props.articleData.id));
    }, {
      loadableGenerated: {
        webpack: function webpack() {
          return [/*require.resolve*/(__webpack_require__("./components/Work weak recursive ^\\.\\/.*$").resolve("./".concat(props.articleData.id)))];
        },
        modules: ["../../components/Work/".concat(props.articleData.id)]
      }
    });
    _this.Components = "123";
    return _this;
  }
...
//# sourceMappingURL=work.js.4504e84a98b93c888cf4.hot-update.js.map