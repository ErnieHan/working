...
var Button = styled_components__WEBPACK_IMPORTED_MODULE_8__["default"].button.withConfig({
  displayName: "login-and-register__Button",
  componentId: "sc-1su69q2-6"
})(["border:1px solid #999;background:transparent;padding:8px 25px;position:relative;margin:15px auto;&::after{content:\"\";display:block;width:100%;height:100%;background:#f4f4f4;position:absolute;top:10px;left:15px;z-index:-1;transition:all 250ms;}&:hover{&::after{top:0;left:0;background:#e9e8e7;}}"]);
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(LoginAndRegister, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Div, null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Button, null, "\u52A0\u5165\u8CFC\u7269\u8ECA"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(SubTitle, null, "\u4E00\u3001\u8A3B\u518A\u884C\u70BA"), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(Form, {
...
//# sourceMappingURL=2.ffe4e68600549b378441.hot-update.js.map